...
// Cap on total assets we subscribe to. We still fetch books for the rest via
// HTTP on the periodic resync — WS is purely a reactivity layer for the top of
// the table.
const MAX_STREAMED_ASSETS = 1000
